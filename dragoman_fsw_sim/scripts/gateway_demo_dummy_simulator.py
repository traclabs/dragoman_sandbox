...
if __name__ == "__main__":
    ...
    parser.add_argument("--tm-port", type=int, default=10019,
                        help='Telemetry destination port (default: 10019)')
    parser.add_argument("--tc-host", type=str, default='127.0.0.1',
                        help='Telecommand receive host (default: 127.0.0.1)')
    parser.add_argument("--tc-port", type=int, default=10029,
                        help='Telecommand receive port (default: 10029)')
